  ...
  context "POST checkout" do
    ...
    context "hbx_enrollment can not select_coverage" do
      ...
      before :each do
        ...
        allow(errors).to receive(:full_messages).and_return("You can not keep existing plan by different plan year")
      end
      ...
      it "should get flash" do
        post :checkout, id: "hbx_id", plan_id: "plan_id"
        expect(flash[:error]).to include("You can not keep existing plan by different plan year")
      end
    end
  end
